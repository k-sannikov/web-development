    ...
    <main class="main">
      ...
      <section class="bottom-container">
        ...
        <form class="form" method="post" action="index.php#write-me">
          ...
          <input class="form__input" type="text" name="name" id="name" value="<?= $args['name'] ?? ''; ?>" />
          ...
          <input class="form__input" type="email" name="email"  id="email" value="<?= $args['email'] ?? ''; ?>" />
          ...
          <textarea class="form__textarea" name="message" id="message"><?= $args['message'] ?? ''; ?></textarea>
